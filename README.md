...
Monitor baterai **JK BMS** via Bluetooth Low Energy (BLE), ditampilkan pada layar sentuh TFT 2.8" bawaan board **ESP32-2432S028R** (Cheap Yellow Display / CYD).

## Fitur Utama

- **Splash screen** animasi boot dengan countdown 3 detik sebelum BLE scan dimulai
- **Scan BLE otomatis** selama 8 detik, lalu langsung masuk daftar perangkat
...
### Protokol Lama — Fixed Frame `55AAEB90` (JK01 / Variant)
